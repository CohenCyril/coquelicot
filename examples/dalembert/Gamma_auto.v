...
Require Import AutoDeriv Partial_function Partial_function2.
...
(** Dans ce fichier, les preuves de dérivabilité des fonctions auxiliaires 
ont été faites à l'aide de la tactique AutoDerive *)
...
Proof.
  ...
  apply (continuity2_pt_proj1 (fun x => c*(t-x)) _ _).
...
Proof.
  ...
  assert (continuity (fun xi => f xi tau)).
    apply (cont2_impl_cont f Cf).
