...
extension. They are used to describe limit points and how they are approached.
...
such, its limit point is x and it matches the traditional notion of convergence
in a metric space. Note: [locally x] is also the set of neighborhoods of x.
