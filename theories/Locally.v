...
Lemma locally_2d_locally_2d: forall (P:posreal->R->R->Prop) x y,
   locally_2d (fun u v => forall eps, locally (fun a b => P eps a b) u v) x y ->
   (forall eps, locally_2d (P eps) x y).
intros P x y (d,Hd) eps.
exists d.
intros u v Hu Hv.
now apply Hd.
Qed.
